...
RUN apt-get install -y libxml2 libxml2-dev zlib1g-dev bzip2 libzip-dev libjpeg-dev libgd-dev curl libcurl3 libmcrypt4 libmcrypt-dev libssl-dev openssl libreadline-dev libfreetype6-dev
